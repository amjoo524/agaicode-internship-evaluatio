    ...
    try {
      ...
      if (selectedTopics && selectedTopics.length > 0) {
        const TOPIC_KEYWORD_MAP: Record<string, string[]> = {
          ...
          'Template Literals & String Concatenation': ['template literal', 'template string', 'backtick', 'interpolation', '${', 'string concatenation', 'concat', 'multiline', 'touppercase', 'tolowercase', 'trim', 'split', 'replace', 'includes', 'startswith', 'endswith', 'slice', 'indexof'],
