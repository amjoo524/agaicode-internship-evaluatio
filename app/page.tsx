    ...
    try {
      ...
      if (selectedTopics && selectedTopics.length > 0) {
        const TOPIC_KEYWORD_MAP: Record<string, string[]> = {
          ...
          'Arrays & Array Methods (push, pop, shift, unshift, indexOf)': ['array', '2d array', 'matrix', 'indexof', 'push', 'pop', 'shift', 'unshift', 'includes', 'reverse', 'concat', 'slice', 'splice', 'spread', 'arr', 'length'],
          'Template Literals & String Concatenation': ['template literal', 'template string', 'backtick', 'interpolation', '${', 'string concatenation', 'concat', 'multiline', 'touppercase', 'tolowercase', 'trim', 'split', 'replace', 'replaceall', 'includes', 'startswith', 'endswith', 'slice', 'indexof'],
